...
**業務意義**：衡量體驗課的轉換效果，是評估課程品質和銷售策略的核心指標
  ...
  avgConversionTime: {
    ...
    title: '平均轉換時間',
    shortDesc: '從最早上課日期到成交的平均天數',
    fullDesc: `
**定義**：學生從最早上課日期到完成高階課程購買的平均時間

**計算方式**：
- 對每筆成交記錄，計算「成交日期 - 最早上課日期」
- 取所有有效配對的平均值（僅計算成交日期在上課之後的記錄）
...
**業務意義**：行銷和客服的重點工作對象，需要定期跟進確保完課率
  ...
  potentialRevenue: {
    ...
    fullDesc: `
**定義**：已轉高學生在 EODs 表中「高階一對一」或「高音」方案的實收金額總和

**計算邏輯**：
1. 篩選「已轉高」學生的 Email
2. 在成交記錄（EODs）中找到對應的高階方案
3. 只計算方案名稱包含「高階一對一」或「高音」的記錄
4. 只計算成交日期在最早上課日期之後的記錄
5. 加總實收金額
